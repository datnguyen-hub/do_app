class UpdateDeviceTokenResponse {
  ...
  UpdateDeviceTokenResponse.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new DeviceTokenCustomer.fromJson(json['data']) : null;
  }
...
class DeviceTokenCustomer {
  ...
  DeviceTokenCustomer.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
