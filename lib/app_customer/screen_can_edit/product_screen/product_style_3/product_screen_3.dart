                                  ...
                                  children: [
                                                      ...
                                                      children: [
                                                        productController
                                                            ...
                                                            ? Row(
                                                                children: [
                                                                  SahaMoneyText(
                                                                    price: checkMinMaxPrice(productController
                                                                        .productShow
                                                                        .value
                                                                        .minPrice),
                                                                    color: SahaColorUtils()
                                                            ...
                                                            : productController
                                                                ...
                                                                : Column(
                                                                    children: [
                                                                      productController.productShow.value.productDiscount !=
                                                                              null
                                                                          ? Row(
                                                                              children: [
                                                                                SahaMoneyText(
                                                                                  price: productController.productShow.value.productDiscount?.discountPrice ?? 0,
                                                                                  color: SahaColorUtils().colorPrimaryTextWithWhiteBackground(),
                                                                                ),
                                                                                SizedBox(
                                                                                  width: 10,
                                                                                ...
                                                                                Text(
                                                                                  "₫${SahaStringUtils().convertToMoney(productController.productShow.value.maxPrice ?? 0)}",
                                                                                  style: TextStyle(decoration: TextDecoration.lineThrough, color: Colors.grey, fontWeight: FontWeight.w600, fontSize: 13),
                                                                                ),
                                                                                SizedBox(
                                                                                  width: 10,
                                                                                ),
                                                                                Text(
                                                                                  "-${SahaStringUtils().convertToMoney(productController.productShow.value.productDiscount?.value ?? 0)}%",
                                                                                  style: TextStyle(fontSize: 12, color: SahaColorUtils().colorPrimaryTextWithWhiteBackground()),
                                                                                ),
                                                                              ],
                                                                            )
                                                                          : SahaMoneyText(
                                                                              price: productController.productShow.value.minPrice ?? 0,
                                                                              color: SahaColorUtils().colorPrimaryTextWithWhiteBackground(),
                                                                            ),
                                                                    ],
                                                                  ),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              if (productController
                                                  ...
                                                  0)
                                                Text(
                                                  "(Xem ${productController.totalReview.value} đánh giá)",
                                                  style: TextStyle(
                                                      fontSize: 13,
                                                      color: Colors.grey),
                                                ),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          SvgPicture.asset(
                                            "packages/sahashop_customer/assets/icons/payment.svg",
                                            height: 15,
                                            width: 15,
                                            color: Colors.red,
                                          ),
