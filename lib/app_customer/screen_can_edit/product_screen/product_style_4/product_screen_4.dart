...
class ProductScreen4 extends StatefulWidget {
  @override
  State<ProductScreen4> createState() => _ProductScreen4State();
}

class _ProductScreen4State extends State<ProductScreen4> {
                ...
                () => !productController.isLoadingProduct.value
                    ? Column(
                        children: [
                          ...
                          if (productController.productShow.value.id == null)
                            Container(
