...
import 'package:sahashop_customer/app_customer/screen_can_edit/home/home_style_4/home_style_4_controller.dart';
          ...
          children: [
            ...
            Column(
              children: [
                Obx(
                  () => SizedBox(
                    height: homeStyle4Controller.isTouch.value ? 90 : 120,
                  ),
                ),
                Expanded(
                  child: RefreshIndicator(
                    color: Colors.indigo,
                    onRefresh: () async {
                      await homeStyle4Controller.refresh();
                    },
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          Obx(() => homeStyle4Controller.isRefresh.value
                              ? HomeBodyWidget()
                              : HomeBodyWidget()),
                        ],
                      ),
