...
import 'package:sahashop_customer/app_customer/components/image_edit/extension/num_extension.dart';
...
// import '../image_editor/lib/extension/num_extension.dart';
// import 'package:path_provider/path_provider.dart';
// import 'package:screenshot/screenshot.dart';
//
// import '../image_editor/lib/model/float_text_model.dart';
// import '../image_editor/lib/widget/drawing_board.dart';
// import '../image_editor/lib/widget/editor_panel_controller.dart';
// import '../image_editor/lib/widget/float_text_widget.dart';
// import '../image_editor/lib/widget/image_editor_delegate.dart';
// import '../image_editor/lib/widget/text_editor_page.dart';
...
class ImageEditorState extends State<ImageEditor>
  ...
  void saveImage(Widget widgetCapture) {
    double pixelRatio = MediaQuery.of(context).devicePixelRatio;
    _panelController.takeShot.value = true;
    screenshotController.capture(pixelRatio: pixelRatio).then((value) async {
          ...
          Expanded(
            child: Row(
              children: [
                ...
                doneButtonWidget(onPressed:(){
                  saveImage(_buildImage());
                }),
              ],
            ),
          )
