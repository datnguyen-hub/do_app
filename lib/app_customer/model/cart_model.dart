...
class CartModel {
  CartModel({
    ...
    this.totalFinal,
    this.balanceAgencyCanUse,
    this.balanceAgencyUsed,this.vat,this.isOrderForCustomer,this.totalCommissionOrderForCustomer
  });

  double? totalBeforeDiscount;
  double? balanceCollaboratorCanUse;
  double? balanceCollaboratorUsed;
  double? balanceAgencyCanUse;
  ...
  factory CartModel.fromJson(Map<String, dynamic> json) => CartModel(
        ...
        balanceAgencyCanUse: json["balance_agency_can_use"] == null
            ? null
            : json["balance_agency_can_use"].toDouble(),
        balanceAgencyUsed: json["balance_agency_used"] == null
            ? null
            : json["balance_agency_used"].toDouble(),
