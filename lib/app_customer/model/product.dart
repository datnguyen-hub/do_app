...
class Product {
  Product(
      ...
      this.customView,
      this.videoUrl,
      this.isMedicine,this.isProductRetailStep,this.productRetailSteps});
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
      ...
      attributeSearchChildren: json["search_children"] == null ? null : List<AttributeSearch>.from(json["search_children"].map((x) => AttributeSearch.fromJson(x))),
      percentCollaborator: json["percent_collaborator"] == null ? 0 : json["percent_collaborator"].toDouble(),
      percentAgency: json["percent_agency"] == null ? 0 : json["percent_agency"].toDouble(),
      ...
      distributeStock: json["distribute_stock"] == null ? null : List<DistributeStock>.from(json["distribute_stock"].map((x) => DistributeStock.fromJson(x))),
      importExport: json["import_export"] == null ? null : List<ImportExport>.from(json["import_export"].map((x) => ImportExport.fromJson(x))),
      level: json['level'],
...
class ElementDistributes {
  ...
  ElementDistributes({
    ...
    this.priceBeforeOverride,this.sku
  });
  ...
  ElementDistributes.fromJson(Map<String, dynamic> json) {
    ...
    priceBeforeOverride = json["price_before_override"] == null ? null : json["price_before_override"].toDouble();   
...
class SubElementDistribute {
  SubElementDistribute({
    ...
    this.exportImportPrice,
    this.exportCountStock,
    this.exportTotalAmount,this.priceBeforeOverride,this.sku
  });
...
class ProductRetailStep {
    ...
    factory ProductRetailStep.fromJson(Map<String, dynamic> json) => ProductRetailStep(
        id: json["id"],
        storeId: json["store_id"],
        productId: json["product_id"],
        fromQuantity: json["from_quantity"],
        toQuantity: json["to_quantity"],
        price: json["price"] == null ? null :json["price"].toDouble() ,
