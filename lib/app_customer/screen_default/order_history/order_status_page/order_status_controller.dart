...
class OrderStatusController extends GetxController {
  ...
  OrderStatusController(
      {this.fieldBy, this.fieldByValue, this.dateFrom, this.dateTo});
    ...
    try {
      if (isEndOrder == false) {
        var res = await CustomerRepositoryManager.orderCustomerRepository
            .getOrderHistory(
          numberPage: currentPage, fieldBy: fieldBy,
          filterByValue: fieldByValue,
          dateFrom: dateFrom == null
              ? null
              : DateFormat("dd-MM-yyyy").format(dateFrom!),
          dateTo:
              dateTo ==null ? null : DateFormat("dd-MM-yyyy").format(dateTo!),
          //sortBy: "",search: "",dateFrom: '',dateTo: '',descending: ''
        );
