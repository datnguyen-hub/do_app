...
import 'payment_history_agency_controller.dart';

class PaymentHistoryAgencyCTVScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SmartRefresher(
        ...
        onRefresh: () async {
          await paymentHistoryController.getPaymentAgencyHistory(
              isRefresh: true);
        ...
        child: SingleChildScrollView(
          child: Obx(
            () => Column(
                ...
                children: paymentHistoryController.listPaymentAgencyHtr
                    .map(
                      (element) => boxHistory(
