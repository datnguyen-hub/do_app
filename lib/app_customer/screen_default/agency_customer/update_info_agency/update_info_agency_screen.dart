...
import 'package:sahashop_customer/app_customer/screen_default/agency_customer/update_info_agency/udpate_info_agency_controller.dart';
...
class UpdateInfoAgencyScreen extends StatelessWidget {
  UpdateInfoAgencyScreen({super.key, this.isFromCheckStatus}) {
    controller =
        UpdateInfoAgencyController(isFromCheckStatus: isFromCheckStatus);
  }
  final _formKey = GlobalKey<FormState>();
  late UpdateInfoAgencyController controller;
                    ...
                    child: Column(
                      children: [
                        SahaTextFieldNoBorder(
                          ...
                          onChanged: (v) {
                            controller.agencyReq.value.firstAndLastName = v!;
                          },
                          // validator: (value) {
                          //   if (value!.isEmpty) {
                        ...
                        SahaTextFieldNoBorder(
                          ...
                          onChanged: (v) {
                            controller.agencyReq.value.accountName = v!;
                          },
                          // validator: (value) {
                          //   if (value!.isEmpty) {
                          //     SahaAlert.showError(message: "Chưa nhập họ tên");
                        ...
                        SahaTextFieldNoBorder(
                          ...
                          onChanged: (v) {
                            controller.agencyReq.value.accountNumber = v!;
                          },
                          // validator: (value) {
                          //   if (value!.isEmpty) {
                        ...
                        SahaTextFieldNoBorder(
                          ...
                          onChanged: (v) {
                            controller.agencyReq.value.bank = v!;
                          },
                          // validator: (value) {
                          //   if (value!.length == 0) {
                          //     return 'Không được để trống';
                        ...
                        SahaTextFieldNoBorder(
                          ...
                          onChanged: (v) {
                            controller.agencyReq.value.branch = v!;
                          },
                          // validator: (value) {
                          //   if (value!.isEmpty) {
                        ...
                        SahaTextFieldNoBorder(
                          ...
                          onChanged: (v) {
                            controller.agencyReq.value.cmnd = v!;
                          },
                          // validator: (value) {
                          //   if (value!.isEmpty) {
                          //     SahaAlert.showError(message: "Chưa nhập số CMND/CCCD");
                                ...
                                Padding(
                                  ...
                                  child: Obx(
                                    () => ImagePickerSingle(
                                      ...
                                      height: Get.width / 4,
                                      linkLogo:
                                          controller.agencyReq.value.frontCard,
                                      onChange: (link) {
                                        print(link);
                                        controller.agencyReq.value.frontCard =
                                            link;
                                ...
                                Padding(
                                  ...
                                  child: Obx(
                                    () => ImagePickerSingle(
                                      ...
                                      height: Get.width / 4,
                                      linkLogo:
                                          controller.agencyReq.value.backCard,
                                      onChange: (link) {
                                        print(link);
                                        controller.agencyReq.value.backCard = link;
                                      },
                                    ),
                                  ),
                                ),
