...
import 'package:sahashop_customer/app_customer/screen_default/ctv_customer/order_history/order_history_detail/order_detail_history_screen.dart';
...
class OrderStatusPage extends StatefulWidget {
  ...
  OrderStatusPage(
      ...
      this.dateFrom,
      this.dateTo}) {
    orderStatusController = new OrderStatusController(isCtv: isCtv);
  }
...
class _OrderStatusPageState extends State<OrderStatusPage>
  ...
  void initState() {
    ...
    orderStatusController.isCtv = widget.isCtv;
