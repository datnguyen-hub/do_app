...
import 'package:sahashop_customer/app_customer/screen_default/agency_customer/report/report_controller.dart';
...
class ReportAgencyScreen extends StatelessWidget {
  ...
  late ReportsController reportController;
    ...
    return InkWell(
      onTap: () {
        Get.to(() => ChooseTimeScreen(
            ...
            .then((value) => {
                  reportController.getReportAgency(),
                });
      },
      child: Padding(
