...
class ReportsController extends GetxController {
  ...
  ReportsController({this.collaboratorByCustomerId, this.agencyByCustomerId,required this.isCtv}) {
  ...
  Future<void> getReportAgency() async {
    isLoading.value = true;
    try {
      DetailsByPaymentStatus? detailsByPaymentStatus;
      DetailsByOrderStatus? detailsByOrderStatus;
      var res = await CustomerRepositoryManager.reportRepository.getReportAgency(
