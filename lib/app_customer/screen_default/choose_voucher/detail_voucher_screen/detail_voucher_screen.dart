...
import 'package:sahashop_customer/app_customer/screen_default/choose_voucher/detail_voucher_screen/detail_voucher_controller.dart';
import 'package:sahashop_customer/app_customer/screen_default/choose_voucher/detail_voucher_screen/list_product_voucher/list_product_voucher_screen.dart';
...
class DetailVoucherScreen extends StatelessWidget {
  ...
  DetailVoucherScreen({this.voucher}) {
    controller = DetailVoucherController(voucherId: voucher?.id);
  }
  DataAppCustomerController dataAppCustomerController = Get.find();
  CartController cartController = Get.find();
  late DetailVoucherController controller;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                            ...
                            voucher!.voucherType == 1
                                ? Container(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                            "Chỉ áp dụng cho các sản phẩm sau: "),
                                        ...List.generate(
                      ...
                      //     bottom: 10,
                      //   ),
                      //   child: Text('Sản phẩm có thể áp dụng voucher',
                      //       style: TextStyle(
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: Column(
          children: [
            SahaButtonFullParent(text: "Sản phẩm có thể áp dụng voucher",onPressed: (){
              Get.to(()=>ListProductVoucerScreen(voucherId: voucher!.id!,));
            },)
          ],
        ),
      ),
          ...
          child: Column(
            ...
            children: [
              CachedNetworkImage(
                ...
                width: Get.width,
                fit: BoxFit.cover,
                imageUrl: product.images == null || product.images!.isEmpty
                    ? ""
